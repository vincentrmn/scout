...
// Le cookie de session = HMAC-SHA256(SESSION_SECRET, "bbinvest-ok"), en base64url.
...
export async function sessionToken(): Promise<string> {
  ...
  const sig = await crypto.subtle.sign("HMAC", key, enc.encode("bbinvest-ok"));
...
export const SESSION_COOKIE = "bbinvest_session";
