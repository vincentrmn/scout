...
export default function NewSearch() {
  ...
  const [communes, setCommunes] = useState("luxembourg");
  ...
  function buildPayload() {
    ...
    return {
      ...
      criteria: {
        propertyType,
        communes: communes.split(",").map((s) => s.trim().toLowerCase()).filter(Boolean),
    ...
    <div className="wrap">
      ...
      <div className="card">
        ...
        <div className="row" style={{ marginTop: 16 }}>
          ...
          <div>
            <label>Communes / quartiers (séparés par virgule)</label>
            <input type="text" value={communes} onChange={(e) => setCommunes(e.target.value)} />
          </div>
        </div>
