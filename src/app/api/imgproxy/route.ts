...
// S11 — Proxy d'images (même origine) pour pouvoir intégrer photos atHome et
// tuiles de carte dans les exports PDF (sinon bloquées par CORS côté navigateur).
// Hosts strictement whitelistés (pas de SSRF ouvert).
const ALLOWED = [
  /(^|\.)static\.athome\.eu$/i,
